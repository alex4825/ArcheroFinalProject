...
namespace Assets._Project.Develop.Runtime.Gameplay.EntitiesCore
{
    public partial class Entity : IDisposable, IEquatable<Entity>
    {
        ...
        {
            if (TryGetComponent<TComponent>(out TComponent component) == false)
                throw new ArgumentException($"Entity component doesn't exist - {typeof(TComponent)}");
